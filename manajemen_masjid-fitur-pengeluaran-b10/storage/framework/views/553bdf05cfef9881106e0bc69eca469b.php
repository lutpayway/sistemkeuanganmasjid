...
<div class="container px-6 mx-auto grid">
    ...
    <div class="flex border-b border-gray-200 mb-6">
        ...
        <a href="<?php echo e(route('pengeluaran.index')); ?>" class="py-2 px-4 text-gray-500 hover:text-green-600 focus:outline-none">
            Pengeluaran
        </a>
    ...
    <div x-data="{ openModal: false, isEdit: false, formData: { id: '', nama_kategori: '', deskripsi: '' } }">
                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y">
                        ...
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 font-semibold"><?php echo e($item->nama_kategori); ?></td>
                            <td class="px-4 py-3 text-sm"><?php echo e($item->deskripsi ?? '-'); ?></td>
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-2 text-sm">
                                    <button 
                                        @click="openModal = true; isEdit = true; formData = { id: '<?php echo e($item->id); ?>', nama_kategori: '<?php echo e($item->nama_kategori); ?>', deskripsi: '<?php echo e($item->deskripsi); ?>' }"
                                    ...
                                    <form action="<?php echo e(route('kategori-pengeluaran.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Hapus kategori ini? Data pengeluaran terkait juga akan terhapus.')">
                                        <?php echo csrf_field(); ?>
        ...
        >
            ...
            >
                ...
                <form :action="isEdit ? '<?php echo e(url('kategori-pengeluaran')); ?>/' + formData.id : '<?php echo e(route('kategori-pengeluaran.store')); ?>'" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\manajemen_masjid\resources\views/modules/keuangan/kategori/index.blade.php ENDPATH**/ ?>